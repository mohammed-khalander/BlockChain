# Token deployment script (classic scripts way)
...
### Option 2️⃣: Persistent local chain (advanced preview)
...
eth_sendTransaction
  ...
  Transaction:         0x6cacf35980d49740a559c00c257bf5e7a35b4d68ef50cf515875f9121a853e70
  From:                0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266
  Value:               0 ETH
  Gas used:            604456 of 604456
  Block #1:            0xbf86717b06f6f39747248dac28b103b539a6df351c23df7d2beca3e7d2d07c73
...
```
$ bunx hardhat run scripts/Token.ts --network localhost

Deploying Token to network: localhost 
...
Yep — **you *do* need to pass a proper JSON-RPC request body** 👍
Right now Postman is sending *either nothing* or something malformed, so Hardhat can’t parse it.

Let’s fix it step by step.

---

## ✅ Correct way to call Hardhat RPC from Postman
...
Without this, Postman sometimes sends an empty or invalid body.

---

### 4️⃣ Body (THIS IS REQUIRED)
...
If you see this → 🎉 your RPC is working perfectly.
